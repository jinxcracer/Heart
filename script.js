...
$heart.on('click', function(){
    if(!$body.hasClass('is-animating')){
      ...
      littleHeartTimeline
        ...
        .set($headingContainer, {autoAlpha: 1})
        .set($headingText, {autoAlpha: 0})
        .set($headingText.chars, {autoAlpha:0, rotationY: 180})
        .to($headingText.chars, {autoAlpha: 1, rotationY: 0, stagger: 0.1})
        .to($headingText.chars, {autoAlpha: 0, rotationY: 120, stagger: 0.1}, '+=1')
        .set($loveContainer, {autoAlpha: 0})
        .set($headingContainer, {autoAlpha: 0})
